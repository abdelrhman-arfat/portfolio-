    ...
    >
      ...
      <div className="bg-neutral-900 p-6">
        <p className="text-lg leading-8 ">
          ...
          next js , useing redux tookit for state mangement , can use redux
          persist, I know about GSAP js and now imporve my skills in GSAP js and
          three js,I am using tailwind css framework for styling and responsive
